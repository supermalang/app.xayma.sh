...
export default {
  ...
  auth: {
    ...
    phone_invalid_for_country: 'Le numéro ne correspond pas au format du pays sélectionné',
    country: 'Pays',
    ...
    system_version: 'Version système',
    status: 'Statut',
    ...
    check_email_to_verify: 'Consultez votre boîte de réception pour vérifier votre email et finaliser votre compte.',
    password_requirements: 'Au moins 6 caractères, avec une majuscule, une minuscule et un chiffre.',
    ...
    password_too_weak: 'Mot de passe trop faible. Utilisez au moins 6 caractères avec majuscule, minuscule et chiffre.',
  ...
  credits: {
    ...
    top_up: {
      ...
      description: 'Rechargez votre solde pour maintenir vos instances Odoo. Les crédits sont ajoutés instantanément à votre compte après paiement.',
      current_balance: 'Solde actuel',
      step_amount: '1. Choisir le montant',
      step_payment: '2. Mode de paiement',
      popular: 'Populaire',
      summary_title: 'Récapitulatif',
      order_ref: 'Réf. commande',
      selected_credits: 'Crédits sélectionnés',
      processing_fee: 'Frais de traitement ({percent}%)',
      total_due: 'Total à payer',
      complete_purchase: 'Confirmer l\'achat',
      terms_notice: 'En cliquant sur « Confirmer l\'achat », vous acceptez les Conditions d\'utilisation de Xayma.sh. Les crédits ne sont pas remboursables.',
      secure_title: 'Transaction sécurisée',
      secure_description: 'Paiement chiffré SSL via les passerelles régionales.',
      select_amount_first: 'Choisissez un montant ci-dessus pour continuer.',
      select_payment_first: 'Choisissez un mode de paiement pour continuer.',
      no_bundles: 'Aucun forfait de crédits n\'est disponible pour le moment. Revenez bientôt.',
      no_payment_methods: 'Aucun mode de paiement n\'est disponible. Veuillez contacter le support.',
      included_badge: 'Inclus',
      selected_indicator: 'Sélectionné',
      bundle_label_basic: 'Recharge basique',
      bundle_label_standard: 'Recharge standard',
      bundle_label_enterprise: 'Recharge entreprise',
    },
    payment_methods: {
      wave: 'Wave',
    ...
    usage_this_month: 'Utilisation ce mois: {credits} crédits',
    billing_summary: 'Résumé de facturation',
    billing_summary_description: 'Votre prochaine recharge automatique se déclenche lorsque le solde tombe sous 1 000 FCFA.',
    last_top_up: 'Dernière recharge',
    last_invoice: 'Dernière facture',
    download_last_invoice: 'Télécharger la dernière facture',
    no_top_up_yet: 'Aucune recharge',
    transaction_history: 'Historique des transactions',
    type_and_description: 'Type et description',
    ...
    detail: {
      breadcrumb: 'Détails de la transaction',
      title: 'Détail de la transaction',
      export_invoice: 'Exporter la facture',
      raise_dispute: 'Contester',
      account_entity: 'Compte',
      current_balance: 'Solde actuel',
      financial_breakdown: 'Détail financier',
      previous_balance: 'Solde précédent',
      transaction_amount: 'Montant de la transaction',
      resulting_balance: 'Nouveau solde',
      payment_metadata: 'Paiement et métadonnées',
      payment_method: 'Méthode de paiement',
      no_payment_method: 'Non précisée',
      transaction_datetime: 'Date et heure',
      reference_id: 'Référence',
      transaction_type: 'Type de transaction',
      audit_lifecycle: 'Cycle de vie',
      footer_label: 'Registre administratif interne — Xayma.sh',
      footer_disclaimer: 'Cet enregistrement est signé cryptographiquement et immuable. Tous les horodatages sont en UTC+0.',
      dispute_toast_title: 'Contestation',
      dispute_toast_detail: 'La contestation n\'est pas encore disponible. Contactez le support pour assistance.',
      status: {
        completed: 'Traitée',
        pending: 'En attente',
        failed: 'Échouée',
      ...
      event: {
        applied: {
          title: 'Crédits appliqués',
          description: 'Le système a réconcilié le solde du compte avec succès. État de la base: COMMITTED.',
        },
        confirmed: {
          title: 'Passerelle confirmée',
          description: 'La passerelle de paiement a renvoyé une réponse positive. Transaction vérifiée par callback.',
        },
        pending: {
          title: 'En attente de confirmation',
          description: 'En attente de la confirmation de la passerelle de paiement.',
        },
        failed: {
          title: 'Transaction échouée',
          description: 'La transaction n\'a pas pu être finalisée. Consultez la référence pour le message d\'erreur.',
        },
        initiated: {
          title: 'Initiée',
          description: 'Requête de transaction reçue et validée.',
        },
      },
    },
  },
  ...
  deployments: {
    ...
    wizard: {
      ...
      field_prefixed_domain_hint: 'Généré automatiquement à partir du nom du déploiement. Modifiable.',
      field_prefixed_domain_checking: 'Vérification de la disponibilité…',
      field_prefixed_domain_available: 'Disponible',
      field_prefixed_domain_invalid: 'Utilisez uniquement des lettres minuscules, chiffres et tirets.',
  ...
  settings: {
    ...
    gateway_section_display: 'Affichage côté client',
    gateway_display_name: 'Nom affiché',
    gateway_logo_url: 'URL du logo',
    ...
    bundle_label: 'Libellé',
    bundle_credits_amount: 'Crédits',
    bundle_price_xof: 'Prix',
    bundle_validity_days: 'Validité (jours)',
    bundle_required: 'Ce champ est requis',
    bundle_delete_confirm: 'Retirer ce forfait ?',

    // Frais globaux (TVA, frais de traitement, etc.)
    line_items: 'Lignes de frais',
    line_items_hint: 'Appliquées à chaque forfait sur la page Acheter des crédits. Affichées en lignes séparées dans le récapitulatif.',
    add_line_item: 'Ajouter une ligne',
    edit_line_item: 'Modifier la ligne',
    no_line_items_yet: 'Aucune ligne de frais configurée pour le moment.',
    line_item_title: 'Intitulé',
    line_item_title_placeholder: 'ex. TVA, Frais de traitement',
    line_item_type: 'Type',
    line_item_amount: 'Montant',
    line_item_display_order: 'Ordre d\'affichage (optionnel)',
    line_item_display_order_hint: 'Les valeurs plus basses apparaissent en premier.',
    line_item_type_percent: 'Pourcentage',
    line_item_type_fixed: 'Montant fixe',
    line_item_mode: 'Application',
    line_item_mode_additional: 'Additionnelle',
    line_item_mode_included: 'Incluse',
    line_item_mode_hint: 'Additionnelle s\'ajoute au total. Incluse est affichée à titre informatif — déjà dans le prix du forfait.',
    line_item_required: 'Ce champ est requis',
    line_item_delete_confirm: 'Retirer cette ligne de frais ?',
  },
