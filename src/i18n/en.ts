...
export default {
  ...
  auth: {
    ...
    register_benefit_credits_title: 'Credit-based pricing',
  ...
  dashboard: {
    ...
    // Customer dashboard
    partner_overview_subtitle: 'Partner overview and infrastructure health',
    ...
    recent_activity_log: 'Recent activity',
  ...
  credits: {
    ...
    page_title: 'Credits and billing',
    ...
    detail: {
      ...
      resulting_balance: 'New balance',
      payment_metadata: 'Payment and metadata',
  ...
  deployments: {
    ...
    stats: {
      instances_active: 'Active instances',
    ...
    wizard: {
      ...
      version_section_subtitle: 'Select an LTS version.',
      ...
      field_prefixed_domain_hint: 'Auto-generated from the deployment name. You can edit it.',
      field_prefixed_domain_checking: 'Checking availability…',
      field_prefixed_domain_available: 'Available',
      field_prefixed_domain_invalid: 'Use lowercase letters, digits and hyphens only.',
  ...
  commissions: {
    ...
    trend_over_time: 'Commission trend',
  ...
  settings: {
    ...
    container_management: 'Container platform',
