# MARKETING STRATEGY & PLAN — Xayma.sh
> v2 · Last updated: March 2026
...
## 2. ICP (Ideal Customer Profiles)

### ICP 1 — Direct Customer (SME Owner)
| Attribute | Description |
|-----------|-------------|
| Company size | 2–50 employees |
| Sector | Retail, distribution, logistics, professional services |
| Location | Dakar, Abidjan, Douala, Bamako |
| Pain | Needs inventory/accounting/HR software; too expensive or complex to set up |
| Budget | 10,000–20,000 FCFA/month |
| Decision | Owner or finance manager decides; pays via Wave/Orange Money |

### ICP 2 — Reseller (IT Integrator / Digital Agency)
| Attribute | Description |
|-----------|-------------|
...
### Direct Customers (Inbound/Outreach)
```
Awareness → Landing page or WhatsApp outreach
Interest → Watch 2-min demo video on homepage
Consideration → Free 7-day trial (1 Starter instance, no credit required)
Decision → Top up credits → deploy in under 5 minutes
Retention → WhatsApp credit alerts, quick top-up via Wave
```
...
Expansion → Upgrade to Medium/Large bundle within 60 days
```
...
**FCFA-first messaging:** Never show EUR or USD as primary price to West African audience.

| Plan | Headline price | Message |
|------|---------------|---------|
| Starter | 10,000 FCFA / mois | "Pour les petites équipes qui démarrent" |
| Pro | 20,000 FCFA / mois | "Pour une PME qui grandit" |
| Enterprise | 50,000 FCFA / mois | "Pour les équipes exigeantes" |
| Reseller Small | à partir de 8,000 FCFA / instance | "Jusqu'à 20% de remise. Revendez plus, gagnez plus." |

**Trust signals to highlight:**
- ✅ Paiement Wave & Orange Money
- ✅ Prix en FCFA, facturation locale
- ✅ Données hébergées en Europe (RGPD)
- ✅ Support en français
- ✅ Pas de contrat, résiliez quand vous voulez

---

## 6. Launch Plan (April 2026)

### Week -2 (Pre-launch)
- [ ] Landing page live at xayma.sh
...
- [ ] Platform goes live
- [ ] LinkedIn launch post (founder post, product demo video)
- [ ] WhatsApp broadcast to pre-signup list
- [ ] Email to tech communities (Dakar Tech Hub, Silicon Mountain Cameroon)
- [ ] Free trial offer: first 20 customers get 1 month Starter free
- [ ] Submit to Product Hunt (optional, secondary)

### Month 1 Goals
- 5 paying direct customers (self-service)
- 2 reseller accounts onboarded
- 1 case study published (with first reseller)
- NPS collected from all beta customers

---

## 7. Content Calendar (Month 1–3)
...
## 8. Referral Programme (Month 2+)

| Action | Reward |
|--------|--------|
| Customer refers a paying customer | 1 month Starter free (10 credits) |
...
|-----|---------------|----------------|----------------|
| Monthly signups | 10 | 25 | 50 |
| Paying customers | 5 | 20 | 60 |
| Active resellers | 1 | 5 | 20 |
| MRR (FCFA) | 100,000 | 500,000 | 1,500,000 |
| Churn rate | <20% | <15% | <10% |
| Trial → Paid conversion | 20% | 30% | 35% |
| WhatsApp response rate | >50% | >50% | >50% |
