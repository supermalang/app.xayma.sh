# Design Token Reference — Xayma.sh

Human-readable mirror of `src/design-system/tokens.json` (the machine source of truth for all
visual values). The qualitative design language lives in [`/DESIGN.md`](../DESIGN.md); how to use
these tokens in code is in [`design-system.md`](design-system.md).
